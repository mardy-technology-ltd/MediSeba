  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // Ambient Glow Orbs in background matching other tabs
            Positioned(
              top: -60,
              right: -60,
              child: Container(
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Profile Card Header (Glassmorphic High Contrast Dark Theme)
                  ListenableBuilder(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    const Color(0xFF062316).withValues(alpha: 0.9),
                                    const Color(0xFF0B462A).withValues(alpha: 0.9),
                                  ],
                  ...
                  // Quick Grid Actions (Redesigned with glassmorphic cards)
                  GridView.count(
                    shrinkWrap: true,
                  ...
                  // Glassmorphic settings menu container
                  ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                    child: BackdropFilter(
